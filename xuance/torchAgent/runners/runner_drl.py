...
from xuance.torchAgent.agents import get_total_iters
from xuance.torchAgent.representations import REGISTRY as REGISTRY_Representation
from xuance.torchAgent.agents import REGISTRY as REGISTRY_Agent
from xuance.torchAgent.policies import REGISTRY as REGISTRY_Policy
from xuance.torchAgent.utils.input_reformat import get_repre_in, get_policy_in
import itertools
import torch
import gym.spaces
import numpy as np
...
class Runner_DRL(Runner_Base):
    def __init__(self, args):
        ...
        if self.agent_name in ["DDPG", "TD3", "SAC", "SACDIS", "CBDSAC", "A2CCB","A2C"]:
