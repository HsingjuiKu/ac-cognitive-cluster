...
class A2CCB_Agent(Agent):
    ...
    def generate_initial_states(self):
        model_path = "/home/cc/ac-cognitive-cluster/models/a2c/torchAgent/BipedalWalker-v3/seed_1_2024_1028_185135/final_train_model.pth"
            ...
            if self.memory.full:
                ...
                for _ in range(self.n_epoch):
                    ...
                    for start in range(0, self.buffer_size, self.batch_size):
                        ...
                        step_info = self.learner.update(obs_batch, act_batch, ret_batch, adv_batch,idx_batch)
